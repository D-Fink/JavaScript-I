...
let carYear = inventory[33-1].car_year;
let carMake = inventory[33-1].car_make;
let carModel = inventory[33-1].car_model;
...
console.log(JSON.stringify(lastCar));
...
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i].car_make === "Audi" || inventory[i].car_make === "BMW") {
    // BMWAndAudi.push(inventory[i].id, inventory[i].car_make, inventory[i].car_model, inventory[i].car_year)
